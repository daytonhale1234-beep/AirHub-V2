--[[
	...
	Euphoria made by holy © CC0 1.0 Universal (2023)
	https://github.com/Euphoria
...
local GUI = loadstring(game:HttpGet("https://raw.githubusercontent.com/daytonhale1234-beep/AirHub-V2/main/src/UI%20Library.lua"))()
