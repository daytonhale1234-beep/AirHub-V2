...
local library = utility.table({theme = table.clone(themes.AirHub), folder = "Euphoria", extension = "cfg", flags = {}, open = false, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
